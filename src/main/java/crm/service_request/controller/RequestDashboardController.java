...
@WebServlet(name = "RequestDashboardController", value = "/supporter/requests/dashboard")
public class RequestDashboardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            } else if (fromDateString == null || fromDateString.isEmpty() || toDateString == null || toDateString.isEmpty()) {
