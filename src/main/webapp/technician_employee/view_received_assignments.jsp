...
<div class="main-content">
    ...
    <div class="container mt-4">
        <div class="page-header">
            ...
            <p class="subtitle">These are approved tasks the leader has assigned to you. You can accept or decline
                them.</p>
        </div>
                ...
                <div class="stats-bar">
                    ...
                    <div style="flex:2; text-align: right;">
                        <form method="get"
                              ...
                              class="d-flex justify-content-end" style="gap:8px; align-items:center;">
                            <input type="text" name="customerFilter" class="form-control" placeholder="Customer name"
                                   value="${param.customerFilter != null ? param.customerFilter : ''}"
                                   style="width:220px; display:inline-block;"/>
                            <input type="text" name="phoneFilter" class="form-control" placeholder="Phone number"
                            ...
                            <select name="sort" class="form-control" style="width:160px; display:inline-block;">
                                ...
                                <option value="time_asc" ${param.sort == 'time_asc' ? 'selected' : ''}>Oldest first
                                </option>
                            </select>
                        ...
                        <div class="assignment-header">
                            <div>
                                ...
                                <div class="assignment-meta">
                                    ...
                                    Task ID: <strong>#${task.taskID}</strong> | Request ID:
                                    <strong>#${task.request.requestID}</strong>
                                </div>
