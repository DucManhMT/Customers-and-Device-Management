...
<div class="main-content">
    <div class="container-fluid">
        <div class="page-header">
            <h1><i class="fas fa-clipboard-list me-2"></i>Create Product Request</h1>
        </div>
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-body p-4">
                        ...
                        <div class="filter-section">
                            <form action="${pageContext.request.contextPath}/technician_employee/createProductRequests"
                                  method="GET" class="row g-3">
                                <input type="hidden" name="taskID" value="${taskIdStr}"/>
                                <div class="col-md-5">
                                ...
                                <div class="col-md-3 d-flex gap-2">
                                    ...
                                    <a href="${pageContext.request.contextPath}/technician_employee/createProductRequests?taskID=${taskIdStr}"
                ...
                <div class="cart-container">
                    <div class="cart-card">
                        <div class="cart-header">
                            <h5><i class="fas fa-shopping-cart me-2"></i>Product Request Cart</h5>
                        </div>
                        ...
                        <form id="transfer-request-form"
                            ...
                            <input type="hidden" name="taskIdStr" value="${taskIdStr}"/>

                            <div class="cart-items" id="cart-items-container">
                                <div id="cart-empty-msg" class="cart-empty-state">
                                    <i class="fas fa-inbox"></i>
                                    <h6>Your cart is empty</h6>
                                    <p class="small text-muted mb-0">Add products to create a request</p>
                                </div>
                            </div>
                            ...
                            <div class="cart-footer">
                                ...
                                <button type="submit" id="create-request-btn" class="btn btn-create-request w-100"
                                        disabled>
                                    <i class="fas fa-paper-plane me-2"></i>Create Product Request
                                </button>
                            </div>
                        </form>
                    </div>
