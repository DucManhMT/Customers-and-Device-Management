...
<div class="container-fluid px-4 mt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="page-title">Service Request List</h2>
    ...
    <form method="get" action="../requests/list" onkeydown="if(event.key==='Enter'){event.preventDefault();}">
        <div class="filter-section">
            <div class="row align-items-center g-3">
                ...
                <div class="col-md-3">
                    <input type="text" name="customerName" class="form-control" placeholder="Search by Customer Name"
                ...
                <div class="col-md-12 text-end mt-3">
                    <div class="col-12 d-flex gap-2 mt-2">
                        ...
                        <a href="${pageContext.request.contextPath}/customer_supporter/requests/list"
                            ...
                            <td class="text-center">
                                ...
                                <c:if test="${request.requestStatus == 'Pending'}">
                                    <a href="./process?requestId=${request.requestID}"
                                       class="btn btn-warning btn-sm text-dark">Process</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
