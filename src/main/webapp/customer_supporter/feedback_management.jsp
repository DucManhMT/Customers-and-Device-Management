...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="${pageContext.request.contextPath}/customer_supporter/customersupporter_actioncenter" class="btn btn-secondary">Back to Action Center</a>
        </div>
    </div>
    ...
    <div class="card filters">
        <div class="card-body">
            <form id="filterForm" method="post" action="${pageContext.request.contextPath}/customer_supporter/feedback/management" class="row g-2">
                <div class="col-md-3">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <div>
            <c:if test="${currentPage > 1}">
                    <form method="post" action="${pageContext.request.contextPath}/customer_supporter/feedback/management" style="display:inline;">
