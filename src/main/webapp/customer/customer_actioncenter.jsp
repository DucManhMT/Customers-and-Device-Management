...
<html lang="en">
  ...
  <body>
    <c:set var="activePage" value="customer-action-center" scope="request" />
      ...
      <div class="container">
        <div class="card p-2">
          ...
          <p class="text-muted mb-4">
            ...
            >.<br />
            Manage your account, view your contract history, and handle customer
            requests.
          </p>
          ...
          <div class="d-flex flex-wrap">
            ...
            <a
              ...
              class="btn btn-outline-warning nav-link-custom"
            >
              📦 View Products
            </a>
            <a
            ...
            <a href="./requests" class="btn btn-outline-info nav-link-custom">
              📂 View Requests
            </a>
            <a
            ...
            <a
              ...
              class="btn btn-outline-secondary nav-link-custom"
            >
              💬 My Feedback
            </a>
          </div>
