    ...
    <div class="sidebar-inner">
        ...
        <div class="sidebar-category">
            ...
            <div class="category-items" id="category-auth">
                <ul class="sidebar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'customer-register' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/auth/customer_register"><span>Customer Register</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'forgot-password' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/auth/forgot_password"><span>Forgot Password</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="sidebar-category">
            ...
            <div class="category-items" id="category-admin">
                <ul class="sidebar-nav">
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'admin-action-center' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/admin_actioncenter"><span>Action Center</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'role-list' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/role_list"><span>Role List</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'view-role-detail' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/role_list/view_role_detail"><span>View Role Detail</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'edit-role' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/role_list/edit_role"><span>Edit Role</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'create-role' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/role_list/create_role"><span>Create Role</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'account-list' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/account_list"><span>Account List</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'edit-account' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/account_list/edit_account"><span>Edit Account</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'create-account' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/create_account"><span>Create Account</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'view-account-detail' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/account_list/view_account_detail"><span>View Account Detail</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'assign-feature' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/admin/assign_feature"><span>Assign Feature</span></a>
                    </li>
                </ul>
            </div>
        </div>
...
<%--        </div>--%>
        ...
        <div class="sidebar-category">
            ...
            <div class="category-items" id="category-customer">
                <ul class="sidebar-nav">
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'customer-action-center' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/customer/customer_actioncenter"><span>Action Center</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'request-detail' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/customer/requests/detail"><span>Request Detail</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'create-request' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/customer/requests/create"><span>Create Request</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'view-feedback' ? 'active' : ''}"
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${activePage == 'viewTechnicanList' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/technician_leader/employees"><span> View Technician
                            List</span>
                        </a>
                    </li>
                    <li class="nav-item">
