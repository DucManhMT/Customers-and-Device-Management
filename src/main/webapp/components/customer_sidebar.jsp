...
<div id="sidebar" class="sidebar">
    <div class="sidebar-inner">
        <ul class="nav flex-column sidebar-nav">
            <li class="nav-item">
                <a class="nav-link ${activePage == 'cusProfile' ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/customer/profile?id=${account.username}"><i
                        class="bi bi-person-circle"></i>My Profile </a>
            </li>

            <li class="nav-item">
                <a class="nav-link ${activePage == 'viewContractHistory' ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/customer/contract_history"><i
                        class="bi bi-clock-history"></i> Contract History </a>
            </li>
            <li class="nav-item">
                <a class="nav-link ${activePage == 'createRequest' ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/customer/requests/create"><i
                        class="bi bi-clipboard2-plus"></i> Create Request</a>
            </li>
            <li class="nav-item">
