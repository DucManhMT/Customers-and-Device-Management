...
<div class="container">
    ...
    <c:if test="${empty task}">
        <div class="alert alert-error"><i class="fas fa-exclamation-triangle"></i> Task not found or inaccessible.</div>
    </c:if>
    ...
    <c:if test="${not empty task}">
        <div class="info-grid">
            <div class="card">
                ...
                <div class="item"><span class="label">Task ID:</span><span class="value">#${task.taskID}</span></div>
                <div class="item"><span class="label">Assign By:</span><span class="value"><c:choose><c:when
                        test="${not empty assignBy and not empty assignBy.staffName}">${assignBy.staffName}</c:when><c:otherwise><span
                        class="muted">N/A</span></c:otherwise></c:choose></span></div>
                <div class="item"><span class="label">Assign To:</span><span class="value"><c:choose><c:when
                        test="${not empty assignTo and not empty assignTo.staffName}">${assignTo.staffName}</c:when><c:otherwise><span
                        class="muted">N/A</span></c:otherwise></c:choose></span></div>
                <div class="item"><span class="label">Request ID:</span><span class="value"><c:choose><c:when
                        test="${not empty requestObj and not empty requestObj.requestID}">#${requestObj.requestID}</c:when><c:otherwise><span
                        class="muted">N/A</span></c:otherwise></c:choose></span></div>
                <div class="item"><span class="label">Status:</span><span class="value"><c:choose><c:when
                        test="${not empty task.status}"><span
                        class="badge status-${task.status}">${task.status}</span></c:when><c:otherwise><span
                ...
                <div class="item"><span class="label">Start Date:</span><span class="value"><c:choose><c:when
                        test="${not empty task.startDate}">${task.startDate}</c:when><c:otherwise><span class="muted">Not set</span></c:otherwise></c:choose></span>
                </div>
                <div class="item"><span class="label">Deadline:</span><span class="value"><c:choose><c:when
                        test="${not empty task.deadline}">${task.deadline}</c:when><c:otherwise><span class="muted">Not set</span></c:otherwise></c:choose></span>
                </div>
                <div class="item"><span class="label">End Date:</span><span class="value"><c:choose><c:when
                        test="${not empty task.endDate}">${task.endDate}</c:when><c:otherwise><span class="muted">Not finished</span></c:otherwise></c:choose></span>
                </div>
            </div>
        ...
        <div class="section">
            ...
            <div class="description-box">
                <c:choose>
                    <c:when test='${not empty task.description}'>${task.description}</c:when>
                    <c:otherwise><span class="muted">No description provided.</span></c:otherwise>
                </c:choose>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="description-box">
                <c:choose>
                    <c:when test='${not empty task.taskNote}'>${task.taskNote}</c:when>
                    <c:otherwise><span class="muted">No additional notes.</span></c:otherwise>
                </c:choose>
            </div>
        </div>

        <div class="actions">
            <a href="${pageContext.request.contextPath}/technician_leader/tasks/list" class="btn btn-secondary"><i
