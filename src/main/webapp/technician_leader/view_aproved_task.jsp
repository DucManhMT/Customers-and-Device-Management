      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card card-custom filter-card mb-4">
            ...
            <div class="card-body">
              <form method="POST" action="${pageContext.request.contextPath}/task/viewAprovedTask" id="filterForm">
              ...
              <div class="card-body">
                ...
                <div id="selectedTasksContainer" style="display: none">
                  ...
                  <template id="selectedTaskTemplate">
                    <div class="selected-task-item p-3 mb-2 rounded bg-light border d-flex justify-content-between align-items-start" data-task-id="">
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-start">
                          <div>
                            <div class="fw-semibold text-primary selected-task-desc">Request description</div>
                            <div class="small text-muted selected-task-note">Note</div>
                          </div>
                          <div class="text-end ms-3">
                            <div class="small text-muted">REQ-<span class="selected-task-id">0</span></div>
                      ...
                      <div class="ms-3 text-end">
                        <div class="d-flex flex-column gap-2">
                          <button class="btn btn-sm btn-outline-primary selected-task-view" type="button"><i class="bi bi-eye"></i> View</button>
                          <button class="btn btn-sm btn-outline-danger selected-task-remove" type="button"><i class="bi bi-x"></i> Remove</button>
                        </div>
                      </div>
                    </div>
                  </template>
