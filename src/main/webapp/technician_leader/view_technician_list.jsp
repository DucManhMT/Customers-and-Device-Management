                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="filterAge" name="ageRange">
                            ...
                            <option value="18-25" ${selectedAgeRange == '18-25' ? 'selected' : ''}>18-25 years old
                            </option>
                            <option value="26-35" ${selectedAgeRange == '26-35' ? 'selected' : ''}>26-35 years old
                            </option>
                            <option value="36-45" ${selectedAgeRange == '36-45' ? 'selected' : ''}>36-45 years old
                            </option>
                            <option value="46-55" ${selectedAgeRange == '46-55' ? 'selected' : ''}>46-55 years old
                            </option>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-muted">
                        ...
                        <span id="showingEnd">${currentPage * pageSize > totalCount ? totalCount : currentPage * pageSize}</span>
                        of
                        <span id="showingTotal">${totalCount}</span> entries
                    </div>
                    <nav aria-label="Technician pagination">
                        <form id="paginationForm" method="POST"
                              action="${pageContext.request.contextPath}/tech/employees" style="display: none;">
                            <input type="hidden" name="page" id="pageInput" value="${currentPage}">
                            <input type="hidden" name="searchName" value="${searchName}">
                            <input type="hidden" name="location" value="${selectedLocation}">
                            <input type="hidden" name="ageRange" value="${selectedAgeRange}">
                            <input type="hidden" name="recordsPerPage" id="recordsPerPageInput"
