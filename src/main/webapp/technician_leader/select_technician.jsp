                                ...
                                <div class="selected-tasks-list" style="max-height: 300px; overflow-y: auto;">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body py-2">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <strong>Request #<%= req.getRequestID() %></strong><br>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <input class="form-check-input" type="radio" name="selectedTechnician" value="<%= tech.getAccount().getUsername() %>" id="tech_<%= tech.getStaffID() %>">
                                                    </td>
                                                    <td><%= tech.getStaffID() %></td>
                                                    <td><%= tech.getStaffName() %></td>
                                                    <td><a href="tel:<%= tech.getPhone() %>"><%= tech.getPhone() %></a></td>
                                                    <td><a href="mailto:<%= tech.getEmail() %>"><%= tech.getEmail() %></a></td>
                                                    <td><%= tech.getAddress() != null ? tech.getAddress() : "" %></td>
                                                    <td><%= tech.getDateOfBirth() != null ? tech.getDateOfBirth() : "" %></td>
                                                    <td class="text-center">
        ...
        View
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <div class="text-muted">
                                        Showing <span id="showingStart">${((currentPage - 1) * recordsPerPage) + 1}</span> to
                                        <span id="showingEnd">${currentPage * recordsPerPage > totalCount ? totalCount : currentPage * recordsPerPage}</span> of
