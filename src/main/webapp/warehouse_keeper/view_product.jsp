                ...
                <c:forEach var="product" items="${products}">
                    <div class="product-card">
                        <div class="product-card-header">
                            <a href="editProductWarehouse?productID=${product.productID}" class="btn-tag"><i
                        ...
                        <div class="product-card-content">
                            <div>
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    ...
                                    <span class="badge bg-secondary-subtle text-secondary-emphasis rounded-pill">${product.type.typeName}</span>
                                </div>
                                <p class="text-muted small mb-3">${product.productDescription}</p>
                                ...
                                <div class="product-card-footer d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="small text-muted">Stock: <span
                                                class="fw-bold text-dark">${productCounts[product.productID]}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <nav aria-label="Page navigation" class="mt-4 d-flex justify-content-end">
                        <ul class="pagination">
                            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                <a class="page-link"
                                   href="?page=${currentPage - 1}&pageSize=${pageSize}&productName=${productName}&productType=${productType}">Previous</a>
                            </li>
                            ...
                            <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                <a class="page-link"
                                   href="?page=${currentPage + 1}&pageSize=${pageSize}&productName=${productName}&productType=${productType}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </c:if>
